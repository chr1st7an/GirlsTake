...
//  GirlsTake
//
//  Created by Christian Rodriguez on 3/22/23.
//
    ...
    var body: some View {
        content
            ...
            .confirmationDialog("", isPresented: $showDialog) {
                ...
                ForEach(["continue"],id: \.self){index in
                    Button {
                        selectedCropType = options.first!
                        showCropView.toggle()
                    } label: {
                        Label("continue", systemImage: "photo.circle").foregroundColor(gtGreen)
